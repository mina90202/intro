...
@section('content')
    ...
    <div class="br-header">
      ...
      <div class="br-mainpanel">
        ...
        <a href="{{route('porfolios.create')}}" class="btn btn-primary btn-with-icon">
                <div class="ht-40">
                  <span class="icon wd-40"><i class="fa fa-plus"></i></span>
                  <span class="pd-x-15">Add New Porfolio</span>
                </div>
              </a>
              ...
              <table class="table table-bordered table-colored table-info">
                ...
                <tbody>
                  ...
                  <tr>
                  <th scope="row">{{$porfolio->id}}</th>
                    <td><img src="{{asset('upload/'. $porfolio->image)}}" class="img-fluid rounded" alt=""></td>
                    <td>{!! $porfolio->category!!}</td>
                  <td><a style="color:white" type="submit" href="{{route('porfolios.edit', $porfolio->id)}}" name="del_inbox_submit" class="btn btn-info"> Edit <i class="fa fa-trash-o"></i></a></td>
                  <td style="text-align:center">
                    <form action="{{ route('porfolios.destroy',[$porfolio->id]) }}" method="POST">
                        {{ csrf_field() }}
                        @method('DELETE')
