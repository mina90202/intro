    ...
    <div class="br-header">
      ...
      <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            ...
            <form action="{{route('porfolios.update', $porfolio->id)}}" method="POST" enctype='multipart/form-data'>
                  {{csrf_field()}}
                  @method('PUT')
              <div class="form-layout form-layout-1">
                <div class="row mg-b-25">
                  <div class="col-lg-8">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="category" value="{{$porfolio->category}}" required>
                    </div>
                  </div><!-- col-4 -->
                  ...
                  <div class="col-lg-8">
                    ...
                    <img src="{{asset('upload/'. $porfolio->image)}}" class="img-fluid rounded-circle" alt="">
                  </div><!-- col-4 -->
                ...
                <div class="form-layout-footer">
                  <button class="btn btn-primary">Update the Porfolio</button>
