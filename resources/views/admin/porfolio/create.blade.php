    ...
    <div class="br-header">
      ...
      <div class="br-mainpanel">
        <div class="br-pagetitle">
          ...
          <div>
            <h4>Add new Porfolio</h4>
            <p class="mg-b-0"> All Porfolio details from website </p>
          </div>
        </div><!-- d-flex -->
        ...
        <div class="br-pagebody">
            ...
            <form action="{{route('porfolios.store')}}" method="POST" enctype='multipart/form-data'>
                  {{csrf_field()}}
              <div class="form-layout form-layout-1">
                <div class="row mg-b-25">
                  <div class="col-lg-8">
                    <div class="form-group">
                      <label class="form-control-label">The Porfolio Category: <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="category" value="{{old('category')}}" placeholder="Enter a category" required>
                    </div>
                  </div><!-- col-4 -->

                  <div class="col-lg-8">
                    <div class="form-group">
                      <label class="form-control-label">The Porfolio Image: <span class="tx-danger">*</span></label>
                ...
                <div class="form-layout-footer">
                  <button class="btn btn-primary">Add a Porfolio</button>
                <a style="color:white" class="btn btn-secondary" href="{{route('porfolios.index')}}">Cancel</a>
