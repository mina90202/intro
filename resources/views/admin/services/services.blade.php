...
@section('content')
    ...
    <div class="br-header">
      ...
      <div class="br-mainpanel">
        ...
        <a href="{{route('services.create')}}" class="btn btn-primary btn-with-icon">
                <div class="ht-40">
                  <span class="icon wd-40"><i class="fa fa-plus"></i></span>
                  <span class="pd-x-15">Add Service</span>
                </div>
              </a>
              ...
              <table class="table table-bordered table-colored table-info">
                ...
                <tbody>
                  ...
                  <th scope="row">{{$service->id}}</th>
                    <td>{{$service->name}}</td>
                    <td><img src="{{asset('upload/'. $service->image)}}" class="img-fluid rounded" alt=""></td>
                    <td>{!! $service->body!!}</td>
                  <td><a style="color:white" type="submit" href="{{route('services.edit', $service->id)}}" name="del_inbox_submit" class="btn btn-info"> Edit <i class="fa fa-trash-o"></i></a></td>
