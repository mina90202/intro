    ...
    <div class="br-header">
      ...
      <div class="br-mainpanel">
        <div class="br-pagetitle">
          ...
          <div>
            <h4>Add new Post</h4>
            <p class="mg-b-0"> All blog details from website </p>
          </div>
        </div><!-- d-flex -->
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
              <h6 class="br-section-label">Add a new item</h6>
                ...
                <div class="row mg-b-25">
                  <div class="col-lg-8">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="title" value="{{old('title')}}" placeholder="Enter a title" style="border:{{ $errors->has('title') ? '1px solid #fc6a55' : ''}}">
                      @if($errors->has('title'))
                  ...
                  <div class="col-lg-8">
                    <div class="form-group">
                      <label class="form-control-label">The Blog Author: <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="auther" value="{{old('auther')}}" placeholder="Enter a name" style="border:{{ $errors->has('auther') ? '1px solid #fc6a55' : ''}}">
                  ...
                  <div class="col-lg-12">
                    ...
                    <textarea name="sub_body" class="summernote">{{old('sub_body')}}</textarea>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      <label class="form-control-label">The Blog Main Description: <span class="tx-danger">*</span></label>
