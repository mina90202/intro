    ...
    <div class="br-header">
      ...
      <div class="br-mainpanel">
        <div class="br-pagetitle">
          ...
          <div>
            <h4>Blog</h4>
            <p class="mg-b-0"> All Posts details from website </p>
          </div>
        </div><!-- d-flex -->
        ...
        <a href="{{route('blogs.create')}}" class="btn btn-primary btn-with-icon">
                <div class="ht-40">
                  <span class="icon wd-40"><i class="fa fa-plus"></i></span>
                  <span class="pd-x-15">Add New Post</span>
                </div>
              </a>
              ...
              <table class="table table-bordered table-colored table-info">
                ...
                <tbody>
                  ...
                  <th scope="row">{{$blog->id}}</th>
                    <td>{{$blog->title}}</td>
                    <td><img src="{{asset('upload/'. $blog->image)}}" class="img-fluid rounded" alt=""></td>
                    <td>{!! $blog->sub_body!!}</td>
                  <td>{{$blog->auther}}</td>
                  <td><a style="color:white" type="submit" href="{{route('blogs.edit', $blog->id)}}" name="del_inbox_submit" class="btn btn-info"> Edit <i class="fa fa-trash-o"></i></a></td>
