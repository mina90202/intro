      ...
      <div class="br-mainpanel">
        <div class="br-pagetitle">
          ...
          <h4>Edit {{$blog->title}} Post</h4>
            <p class="mg-b-0"> All Blogs details from website </p>
          </div>
        </div><!-- d-flex -->
            ...
            <form action="{{route('blogs.update', $blog->id)}}" method="POST" enctype='multipart/form-data'>
              ...
              <div class="form-layout form-layout-1">
                <div class="row mg-b-25">
                  <div class="col-lg-8">
                    <div class="form-group">
                      <label class="form-control-label">The Blog Title: <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="title" value="{{$blog->title}}" style="border:{{ $errors->has('title') ? '1px solid #fc6a55' : ''}}">
                      @if($errors->has('title'))
                  ...
                  <div class="col-lg-8">
                    <div class="form-group">
                      <label class="form-control-label">The Blog Auther: <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="auther" value="{{$blog->auther}}" style="border:{{ $errors->has('auther') ? '1px solid #fc6a55' : ''}}">
                  ...
                  <div class="col-lg-8">
                    <div class="form-group">
                      <label class="form-control-label">The Blog Image: <span class="tx-danger">*</span></label>
                      <input class="form-control" type="file" name="image" >
                    </div>
                    <img src="{{asset('upload/'. $blog->image)}}" class="img-fluid rounded-circle" alt="">
                  </div><!-- col-4 -->
                   <br>

                   <div class="col-lg-12">
                    <div class="form-group">
                      <label class="form-control-label">The Blog Small Description: <span class="tx-danger">*</span></label>
                    <textarea name="sub_body" class="summernote">{{$blog->sub_body}}</textarea>
                    @if($errors->has('sub_body'))
                    <p class="help-block" style="color: #fc6a55">
                        {{ $errors->first('sub_body') }}
                    </p>
                    @endif
                    </div>
                  </div><!-- col-4 -->
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      <label class="form-control-label">The Blog Description: <span class="tx-danger">*</span></label>
                    <textarea name="body" class="summernote">{{$blog->body}}</textarea>
                    @if($errors->has('body'))
                    <p class="help-block" style="color: #fc6a55">
                        {{ $errors->first('body') }}
                    </p>
                ...
                <div class="form-layout-footer">
                  <button class="btn btn-primary">Update the post</button>
                <a style="color:white" class="btn btn-secondary" href="{{route('blogs.index')}}">Cancel</a>
